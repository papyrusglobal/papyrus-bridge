...
# Stop and remove Papyrus bridge docker containers with private key of validator A
( \
    cd ${ROOT_DIR} && \
...
# Stop and remove Papyrus bridge docker containers with private key of validator B
( \
    cd ${ROOT_DIR} && \
...
# Stop and remove Papyrus bridge docker containers with private key of validator C
( \
    cd ${ROOT_DIR} && \
